...
def extract_ts(base_directory, train_ratio = .7, time_limit=661794):
    ...
    np.save('indian_X_30_train.npy', X_train)
    np.save('indian_Y_30_train.npy', Y_train)
    np.save('indian_X_30_test.npy', X_test)
    np.save('indian_Y_30_test.npy', Y_test)

    return X_train, X_test, Y_train, Y_test

if __name__ == '__main__':

    X_train, X_test, Y_train, Y_test = extract_ts('../indian')
